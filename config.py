...
class Config_EEG_finetune(Config_MBM_finetune):
    def __init__(self):
        ...
        self.eeg_signals_path = os.path.join(self.root_path, '/content/drive/Shareddrives/EEG/Data/eeg_5_95_std.pth')
        self.splits_path = os.path.join(self.root_path, '/content/drive/Shareddrives/EEG/Data/block_splits_by_image_all.pth')

        self.dataset = 'EEG'
        self.pretrain_mbm_path = '../content/drive/Shareddrives/EEG/eeg_pretrain/checkpoint.pth'
